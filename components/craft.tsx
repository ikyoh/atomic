...
const styles = {
  typography: {
    base: [
      ...
      "[&_h2]:sticky [&_h2]:z-20 md:[&_h2]:static [&_h2]:top-[90px] [&_h2]:text-[24px] md:[&_h2]:text-[40px]/12 [&_h2]:font-black [&_h2]:uppercase [&_h2]:tracking-tight [&_h2]:py-5! sm:[&_h2]:py-4!",
      "[&_h3]:text-base [&_h3]:font-bold [&_h3]:uppercase [&_h3]:tracking-tight [&_h3]:mb-8 [&_h3]:mt-8",
      "[&_h4]:text-base [&_h4]:bold [&_h4]:uppercase [&_h4]:tracking-tight",
...
export const Main = ({ children, className, id, ...props }: BaseProps & React.HTMLAttributes<HTMLElement>) => (
  <main className={cn(baseTypographyStyles, className)} id={id} {...props}>
    {children}
  </main>
);
