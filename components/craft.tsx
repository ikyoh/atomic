...
const styles = {
  typography: {
    base: [
      ...
      "[&_h2]:sticky md:[&_h2]:static [&_h2]:top-[90px] [&_h2]:text-[24px] md:[&_h2]:text-5xl [&_h2]:font-black [&_h2]:uppercase [&_h2]:mb-8 [&_h2]:tracking-tight",
      ...
      "[&_h6]:text-base [&_h6]:font-black [&_h6]:uppercase [&_h6]:tracking-tight",
      // Text elements
  ...
  layout: {
    spacing: "[&>*+*]:mt-6",
    article: "max-w-prose",
    container: "mx-auto py-10 md:px-0 [&>*]:mx-auto [&>*]:max-w-3xl space-y-10",
